...
const GlassSocialMedia = () => {
  return (
    <div className="flex items-center justify-end h-full">
      <div className="text-start bg-white/10 backdrop-blur-md rounded-2xl p-10 w-full max-w-md h-full sshadow-[0_8px_32px_rgba(128,0,128,0.3)] border border-white/20 text-white ">
        ...
        <form className="flex flex-col h-full gap-4">
          ...
          <textarea placeholder="Your Message" rows="4" className="p-3 rounded-xl bg-white/20 placeholder-white/70 text-white border-none focus:ring-2 focus:ring-purple-400 outline-none mt-auto" required></textarea>
